const plants = [
  ...
  {
    category: 'Expensive Plants',
    plants: [
      {
        name: 'Air Plant (Tillandsia xerographica)',
        img: '/air-plant.jpg',
        description:
  ...
  {
    category: 'Powerful Plants',
    plants: [
      {
        name: 'Desert Rose (Adenium obesum)',
        img: '/dessert-rose.jpg',
        description:
